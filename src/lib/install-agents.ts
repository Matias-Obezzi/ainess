...
// documents as its install is written down here, and nothing else is attempted — no piping a
// remote script into a shell, and no guessing a command for a CLI that has none, which is what the
// `manual` method is for: it opens the page and lets the user decide.
...
export const INSTALLERS: Record<Exclude<ProviderId, "custom">, InstallMethod> = {
  ...
  antigravity: { kind: "manual", url: "https://antigravity.google/download" },
