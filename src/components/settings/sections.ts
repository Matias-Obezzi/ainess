...
export const SETTINGS_SECTIONS_META: SettingsSectionMeta[] = [
  { id: "general",     labelKey: "settings.section.general",     helpKey: "settings.help.general",     group: "general",    optionKeys: options("general",     ["tray", "notifyApprovals", "notifyResults", "updateCheck", "debugLog", "maxRounds", "autoModel", "approveDelegations", "language", "autoArchive"]), icon: Settings2 },
